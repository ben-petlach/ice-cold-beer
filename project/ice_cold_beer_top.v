module ice_cold_beer_top (
    ...
    output wire [9:0]  LEDR           // LEDs (directly exposed for debugging)
);
...
// Light up LEDs to show raw ADC MSBits for quick visual feedback
assign LEDR = SW[8] ? (SW[7] ? {2'b01, adc_raw_right[11:4]} : {2'b10, adc_raw_left[11:4]}) : 10'd0;
